...
As we have seen with [the-rotary-encoder.md](the-rotary-encoder.md "mention"), instead of being automatically informed of new values using a callback function (push principle), we can read the values directly when we need them:
